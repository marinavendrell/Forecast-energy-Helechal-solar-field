...
if st.sidebar.button('CALCULATE FORECAST'):   # Solamente se ejecuta cuando el usuario hace click en el botón
    ...
    st.write('The application contains an artificial intelligence model designed exclusively for the **Helechal (ES) solar field**.  Therefore, the information uploaded and the predictions will be made only for this field.')
